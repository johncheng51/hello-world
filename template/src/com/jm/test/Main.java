...
public class Main extends AbstractMain{
    ...
    public void assignFolder(String text){
        text=Util.replaceAll(text);
        assignFolder=text;
        log(String.format("assign folder %s",assignFolder));
    }
    ...
    public void web(String file) {   new ProcessWeb(file);  }
    
    public void template(String file) {   new Template(file);  }
    ...
    public void uiang1x(String file){
        UIGen ui=new UIGen();
    ...
    public void ang(){
        UIGen ui=new UIGen();
        ui.setAssignFolder(assignFolder);
