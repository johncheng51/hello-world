...
public abstract class AbstractField {
    ...
    public AbstractField(AbstractModel model,String leftSide, String rightSide) {
        this.model=model;
        getName(leftSide);
        if (!_isObj) processField(nameRest, rightSide);
        else processObject(nameRest, rightSide);
    }
    ...
    public String getType() {
        if (isObj()) return classType+(entity? "Entity":"");
