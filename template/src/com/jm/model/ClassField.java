...
public class ClassField extends AbstractField {
    ...
    public ClassField(AbstractModel model,String leftSide, String objectType) {
          super(model,leftSide, objectType);
       }
    ...
    private void checkPrimary(String name) {
        ...
        for (String word : words) {
            ...
            switch (c) {
                ...
                case 's':if (value != null) size =value;break;
                case 'm':if (value != null) min =value;break;
