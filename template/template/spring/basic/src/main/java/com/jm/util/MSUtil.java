...
public class MSUtil {
    ...
    public static boolean isWhite(String str) {
        ...
        for (int i = 0; i < str.length(); i++)
            flag = flag && isSpace(str.charAt(i));
        return flag;
    }
    ...
    public static char findMatch(String[] table, String whole) {
        for (int i = 0; i < table.length / 2; i++) {
            ...
            if (whole.toLowerCase().indexOf(a) > 0)
                return table[2 * i].charAt(0);
        }
        return (char) 0;
    }
    ...
    public static String printfWithMark(String template, String paramsx, String mark) {
        if (isBlank(paramsx))
            return template;
    ...
    public static Object getProp(Object self, String name) {
        try {
            ...
            log(String.format("Can not read %s from %s",name,self.getClass()));
            return null;
        }
    }
    ...
    public static void setProp(Object self, String name, Object value) {
        ...
        try {
            ...
            log(String.format("Can not set %s from %s",name,self.getClass()));
        }
    }
    ...
    public static Object executeMethod(Object self, String name, Object[] agrs) {
        ...
        try {      return m.invoke(self, agrs);
        } catch (Exception e) {
            log(String.format("Can not execute %s from %s",name,self.getClass()));
            return null;
        }
    }
    ...
    public static Object createObj(String className) {
        try {
            ...
            Object re = myClass.newInstance();
            return re;
        } catch (Exception e) {
            log(String.format("Can not create %s Object",className));
            return null;
        }
    }
    ...
    public static Object createObj(Class  myClass) {
        try {
            ...
            log(String.format("Can not create %s Object",myClass));
            return null;
        }
    }
    ...
    public static byte[] readFileByte(String file) {
        try {
            ...
            log(String.format("Can not read %s File",file));
            return null;
        }
    }
    ...
    public static byte[] readBytes(InputStream is) {
        try {
            ...
            log(String.format("Can not read inputStream"));
            return null;
        }
    }
    ...
    public static String readURL(URL url) {
        try {
            ...
            log(String.format("Can not read %s ",url));
            return null;
        }
    }
    ...
    public static List<String> readURLasList(InputStream inputStream) {
    ...
    public static File writeFile(String fileName, byte[] data) {
        ...
        try {
            ...
            log(String.format("Can not write %s ",fileName));
            return null;
        }
    }
    ...
    public static List<Class> getClasses(String packageName) {
        try {
            ...
            log(String.format("Can not read %s  package",packageName));
            return null;
        }
    }
